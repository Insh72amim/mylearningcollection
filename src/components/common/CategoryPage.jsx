  ...
  return (
    <div className="h-full overflow-y-auto bg-gray-900">
      <div className="max-w-7xl mx-auto p-8 space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-700">
                      <button
                        onClick={() => book.component && setSelectedBook(book.component)}
                      ...
                      >
                        ...
                        {book.component ? 'View Chapters' : 'Chapter details coming soon'}
                      </button>
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-6 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {data.topics.map((topic) => (
              <div
                key={topic.id}
                className={`bg-gray-800 rounded-lg border ${colors.border} p-5 ${colors.hover} transition-all duration-200`}
              >
                <div className="flex items-start gap-3">
                  <Lightbulb className={`w-5 h-5 ${colors.text} mt-0.5 shrink-0`} />
                  <div>
        ...
        {/* Footer Note */}
        <div className={`mt-12 p-6 bg-gray-800 rounded-xl border ${colors.border}`}>
          <p className="text-gray-400 text-sm">
            <span className="font-semibold {colors.text}">Note:</span> This is an overview page. 
            Detailed chapter-by-chapter content for books and in-depth topic explanations will be added progressively.
          </p>
        </div>
      </div>
    </div>
