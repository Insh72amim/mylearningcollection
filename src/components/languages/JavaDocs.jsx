...
import { getJavaSectionData } from "../../data/javaData";

const JavaDocs = ({ onBack, section = "syntax" }) => {
  const [copiedCode, setCopiedCode] = useState("");
  const [selectedTopic, setSelectedTopic] = useState(null);

  const sectionData = getJavaSectionData(section);
    ...
    <div className="h-full overflow-y-auto bg-gray-900 p-8">
      <motion.div
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-bold bg-gradient-to-r from-orange-400 via-red-400 to-yellow-400 bg-clip-text text-transparent mb-4">
            {sectionData.title}
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sectionData.topics.map((topic, index) => (
            <motion.div
              ...
              className="group bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-orange-500 transition-all duration-300 cursor-pointer hover:shadow-xl hover:shadow-orange-500/20"
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <ChevronRight className="w-6 h-6 text-gray-500 group-hover:text-orange-400 transition-colors flex-shrink-0 ml-4" />
              </div>
