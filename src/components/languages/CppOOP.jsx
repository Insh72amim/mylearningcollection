...
import { getCppSectionData } from "../../data/cppData";

const CppOOP = ({ onBack, section = "oop" }) => {
  const [copiedCode, setCopiedCode] = useState("");
  const [selectedTopic, setSelectedTopic] = useState(null);

  const sectionData = getCppSectionData(section);
      ...
      <motion.div
        ...
        <div className="text-center mb-12">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-600 to-emerald-600 rounded-2xl mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sectionData.topics.map((topic, index) => (
            <motion.div
              ...
              className="group bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-green-500 transition-all duration-300 cursor-pointer hover:shadow-xl hover:shadow-green-500/20"
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <ChevronRight className="w-6 h-6 text-gray-500 group-hover:text-green-400 transition-colors flex-shrink-0 ml-4" />
              </div>
        ...
        <motion.div
          ...
          <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
            <h3 className="text-2xl font-bold text-white mb-4">
              Master C++ Object-Oriented Programming
            </h3>
            <p className="text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Dive deep into OOP concepts with comprehensive examples, practical
              implementations, and real-world applications. From basic classes
              to advanced inheritance patterns.
            </p>
          </div>
        </motion.div>
      </motion.div>
