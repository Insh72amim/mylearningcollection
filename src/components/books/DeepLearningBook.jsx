...
const DeepLearningBook = ({ onBack }) => {
  ...
  const chapters = deepLearningChapters;
  ...
  return (
    <div className="w-full max-w-4xl lg:max-w-5xl mx-auto px-4 sm:px-6 lg:px-0 text-gray-300 space-y-8 pb-16 sm:pb-20">
      ...
      <div className="border-b border-gray-700 pb-8">
        <button
          onClick={onBack}
          className="inline-flex items-center gap-2 text-fuchsia-400 hover:text-fuchsia-300 mb-6 transition-colors">
          <ArrowLeft size={20} />
          Back to AI & ML
        </button>

        <div className="flex flex-col gap-4 sm:gap-6 sm:flex-row sm:items-start">
          <div className="w-full sm:w-24 h-24 sm:h-32 bg-gradient-to-br from-fuchsia-700 to-purple-900 rounded-lg shadow-xl flex items-center justify-center shrink-0 border border-fuchsia-600">
            <Brain size={40} className="text-fuchsia-100" />
          </div>
          <div className="text-center sm:text-left">
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-3">
              <span className="px-3 py-1 rounded-full bg-fuchsia-900/50 text-fuchsia-300 text-sm border border-fuchsia-700">
                Foundations
              </span>
              <span className="px-3 py-1 rounded-full bg-purple-900/50 text-purple-300 text-sm border border-purple-700">
                Neural Networks
              </span>
              <span className="px-3 py-1 rounded-full bg-pink-900/50 text-pink-300 text-sm border border-pink-700">
          ...
          <div
            ...
            <button
              ...
              <div className="flex items-start sm:items-center gap-3 sm:gap-4 flex-1">
                <div className="hidden sm:flex items-center justify-center w-10 h-10 rounded-lg bg-fuchsia-900/50 text-fuchsia-400 font-bold text-sm border border-fuchsia-800 shrink-0">
                  {chapter.id.split("-")[1]}
                </div>
            ...
            {expandedChapters[chapter.id] && (
              <div className="px-4 sm:px-6 pb-6 pt-2 border-t border-gray-700 bg-gray-800/50">
                ...
                <div className="mb-6 bg-gray-900/50 p-4 rounded-lg border border-gray-700/50">
                  <h4 className="text-sm font-semibold text-fuchsia-400 mb-2 uppercase tracking-wider">
                    Chapter Overview
                  </h4>
                ...
                {/* Deep Dives */}
                {chapter.deepDive && (
                  <div className="mt-8 bg-gradient-to-br from-fuchsia-900/20 to-purple-900/20 border border-fuchsia-900/50 rounded-xl p-6">
                    <div className="flex items-center gap-2 mb-4">
                      <div className="p-2 bg-fuchsia-900/40 rounded-lg">
                        <Info className="text-fuchsia-400" size={20} />
                      </div>
                      <h3 className="text-xl font-bold text-fuchsia-200">
