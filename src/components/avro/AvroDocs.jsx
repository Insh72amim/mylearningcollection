    ...
    <div className="max-w-5xl mx-auto text-gray-300 space-y-16 pb-20">
      ...
      <div className="border-b border-gray-700 pb-8">
        <h1 className="text-4xl font-bold text-white mb-4">
          Apache Avro: The Deep Dive
        </h1>
        <p className="text-xl text-gray-400">
          A comprehensive guide to the data serialization framework that powers
      ...
      <section>
        ...
        <p className="text-lg leading-relaxed mb-6">
          Avro's killer feature: <strong>schemas evolve independently</strong>{" "}
          of data. Writers and readers can use different schema versions without
          breaking compatibility.
        </p>

        <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 mb-8">
          <h3 className="text-xl font-semibold text-white mb-4">
            The Four Compatibility Types
          </h3>
...
// Avro resolves: V2 reader reads V1 data → email field gets null`}
      ...
      <section>
        ...
        <p className="mb-6">
          Avro encodes data in a <strong>compact binary format</strong>. No
          field names, no field tags—just raw values.
        </p>
        ...
        <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 mb-8">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-900 p-4 rounded border border-gray-600">
              ...
              <p className="text-sm">
                Integers use ZigZag + VarInt encoding for space efficiency.
              </p>
...
// Size: 48 bytes`}
      ...
      <section>
        ...
        <p className="mb-6">
          In production, schemas are stored centrally. Messages only contain a{" "}
          <strong>schema ID</strong>, not the full schema.
        </p>
      ...
      "type": {
        ...
        "symbols": ["PENDING", "SHIPPED", "DELIVERED", "CANCELLED"]
          ...
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
            ...
            <CodeBlock
              language="json"
              code={`// Nullable field: union of [null, string]
{"name": "email", "type": ["null", "string"], "default": null}
        ...
        <div className="mt-6 bg-gray-900 p-6 rounded-xl border border-blue-900/50">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex gap-2">
              <span className="text-blue-400">✓</span> You need{" "}
              <strong>dynamic schema evolution</strong> without breaking
              consumers
            </li>
            <li className="flex gap-2">
              <span className="text-blue-400">✓</span> Working with{" "}
              <strong>Kafka</strong> and Schema Registry
            </li>
            <li className="flex gap-2">
              <span className="text-blue-400">✓</span> Data storage in{" "}
              <strong>Hadoop/Hive/Spark</strong>
            </li>
            <li className="flex gap-2">
              <span className="text-blue-400">✓</span> Need to read data without
              generated code (GenericRecord)
            </li>
            <li className="flex gap-2">
              <span className="text-red-400">✗</span> For low-latency RPCs → use
              Protobuf/gRPC
            </li>
          </ul>
        </div>
...
avrogen -s user.avsc .`}
          ...
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
            <h3 className="text-xl font-semibold text-white mb-4">
              Using Generated Code (Java)
            </h3>
            <CodeBlock
              language="java"
              code={`// Write Avro file
...
while (dataFileReader.hasNext()) {
    ...
    System.out.println(user);
          ...
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
            <h3 className="text-xl font-semibold text-white mb-4">
              Dynamic Deserialization (No Code Gen)
            </h3>
            <CodeBlock
              language="python"
              code={`from avro.datafile import DataFileReader
          ...
          <div className="bg-gray-900 p-6 rounded-xl border border-yellow-900/50">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex gap-2">
                ...
                <strong>Schema Registry</strong> for all production Kafka
                deployments
              </li>
              <li className="flex gap-2">
                <span className="text-yellow-400">•</span> Always set{" "}
                <strong>default values</strong> for new optional fields
              </li>
              <li className="flex gap-2">
                <span className="text-yellow-400">•</span> Use{" "}
                <strong>aliases</strong> when renaming fields for backward
                compatibility
              </li>
              <li className="flex gap-2">
                <span className="text-yellow-400">•</span> Test schema evolution
                with <strong>compatibility checks</strong> before deployment
              </li>
              <li className="flex gap-2">
                <span className="text-yellow-400">•</span> Prefer{" "}
                <strong>record types</strong> over primitive types for
                extensibility
              </li>
              <li className="flex gap-2">
                <span className="text-yellow-400">•</span> Document schema
                changes in <strong>version control</strong>
              </li>
            </ul>
          </div>
        </div>
